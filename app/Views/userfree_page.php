  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="getstarted scrollto" href=<?= base_url('/')?>>Logout</a></li>
        </ul>
		...
		<div class="row">
			<div class="col-md-12 my-2">
				<div class="card-body">
                    ...
                    <tr>
                        <th style="text-align: center;">Tim A</th>
                        <th style="text-align: center;">Skor</th>
                        <th></th>
                        <th style="text-align: center;">Skor</th>
                        <th style="text-align: center;">Tim B</th>
                    </tr>
                    <tr>
                        <th style="text-align: center;">SMA 3 Malang</th>
                        <th style="text-align: center;">10</th>
                        <th style="text-align: center;">vs</th>
                        <th style="text-align: center;">25</th>
                        <th style="text-align: center;">SMA 3 Blitar</th>
                    </tr>
                </table>
				</div>
			</div>
